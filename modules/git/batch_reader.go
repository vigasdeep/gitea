...
func BinToHexHash(hash HashTypeInterface, sha, out []byte) []byte {
...
func ParseTreeLine(hash HashTypeInterface, rd *bufio.Reader, modeBuf, fnameBuf, shaBuf []byte) (mode, fname, sha []byte, n int, err error) {
	var readBytes []byte

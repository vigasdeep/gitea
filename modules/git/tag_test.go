...
`), tag: Tag{
			Name:      "",
			ID:        NewSha1(),
			Object:    &Sha1Hash{[20]byte{0x3b, 0x11, 0x4a, 0xb8, 0x0, 0xc6, 0x43, 0x2a, 0xd4, 0x23, 0x87, 0xcc, 0xf6, 0xbc, 0x8d, 0x43, 0x88, 0xa2, 0x88, 0x5a}},
			Type:      "commit",
...
ono`), tag: Tag{
			Name:      "",
			ID:        NewSha1(),
			Object:    &Sha1Hash{[20]byte{0x7c, 0xdf, 0x42, 0xc0, 0xb1, 0xcc, 0x76, 0x3a, 0xb7, 0xe4, 0xc3, 0x3c, 0x47, 0xa2, 0x4e, 0x27, 0xc6, 0x6b, 0xfc, 0xcc}},
			Type:      "commit",
	...
	for _, test := range testData {
		tag, err := parseTagData(NewSha1(), test.data)

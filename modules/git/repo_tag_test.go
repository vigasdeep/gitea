...
`,
			...
			want: &Tag{
				Name:      "v1.9.1",
				ID:        NewSha1().MustIDFromString("ab23e4b7f4cd0caafe0174c0e7ef6d651ba72889"),
				Object:    NewSha1().MustIDFromString("ab23e4b7f4cd0caafe0174c0e7ef6d651ba72889"),
				Type:      "commit",
...
`,
			...
			want: &Tag{
				Name:      "v0.0.1",
				ID:        NewSha1().MustIDFromString("8c68a1f06fc59c655b7e3905b159d761e91c53c9"),
				Object:    NewSha1().MustIDFromString("3325fd8a973321fd59455492976c042dde3fd1ca"),
				Type:      "tag",
				Tagger:    parseAuthorLine(t, "Foo Bar <foo@bar.com> 1565789218 +0300"),
				Message:   "Add changelog of v1.9.1 (#7859)\n\n* add changelog of v1.9.1\n* Update CHANGELOG.md\n",
				Signature: nil,
...
`,
	...
	for _, test := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			got, err := parseTagRef(NewSha1(), tc.givenRef)

...
`,
			Expected: []*TreeEntry{
				{
					ID:        hash.MustIDFromString("ea0d83c9081af9500ac9f804101b3fd0a5c293af"),
					name:      "README.md",
				...
				{
					ID:        hash.MustIDFromString("037f27dc9d353ae4fd50f0474b2194c593914e35"),
					name:      "README_ZH.md",
					entryMode: EntryModeBlob,
					size:      4681,
					sized:     true,
				...
				{
					ID:        hash.MustIDFromString("9846a94f7e8350a916632929d0fda38c90dd2ca8"),
					name:      "SECURITY.md",
					entryMode: EntryModeBlob,
					size:      429,
					sized:     true,
				...
				{
					ID:        hash.MustIDFromString("84b90550547016f73c5dd3f50dea662389e67b6d"),
					name:      "assets",
	...
	for _, testCase := range testCases {
		entries, err := ParseTreeEntries(hash, []byte(testCase.Input))
...
func TestParseTreeEntriesInvalid(t *testing.T) {
	...
	entries, err := ParseTreeEntries(NewSha1(), []byte("100644 blob ea0d83c9081af9500ac9f804101b3fd0a5c293af"))
	assert.Error(t, err)

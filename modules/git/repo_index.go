...
func (repo *Repository) ReadTreeToIndex(treeish string, indexFilename ...string) error {
	if len(treeish) != repo.Hash.FullLength() {
...
func (repo *Repository) readTreeToIndex(id HashTypeInterface, indexFilename ...string) error {
	var env []string
...
func (repo *Repository) RemoveFilesFromIndex(filenames ...string) error {
	...
	for _, file := range filenames {
		if file != "" {
			...
			buffer.WriteString(repo.Hash.Empty())
			buffer.WriteByte('\t')
...
func (repo *Repository) AddObjectToIndex(mode string, object HashTypeInterface, filename string) error {

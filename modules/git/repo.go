...
// GetHashTypeOfRepo returns the hash type of a repository at a given path
func GetHashTypeOfRepo(ctx context.Context, repoPath string) (HashTypeInterface, error) {
	...
	return HashTypeInterfaceFromHashString(strings.TrimRight(stdout.String(), "\n"))
}

// InitRepository initializes a new Git repository.
func InitRepository(ctx context.Context, repoPath string, bare bool, hashType string) error {
	err := os.MkdirAll(repoPath, os.ModePerm)
	if err != nil {
		return err
	}

	cmd := NewCommand(ctx, "init", "--object-format").AddDynamicArguments(hashType)
	if bare {

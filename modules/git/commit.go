...
type Commit struct {
	Tree
	ID            HashTypeInterface // The ID of this commit object
	Author        *Signature
	Committer     *Signature
	CommitMessage string
	Signature     *CommitGPGSignature

	Parents        []HashTypeInterface // ID strings
...
func (c *Commit) ParentID(n int) (HashTypeInterface, error) {
	if n >= len(c.Parents) {
...
func (c *Commit) HasPreviousCommit(commitHash HashTypeInterface) (bool, error) {
	this := c.ID.String()

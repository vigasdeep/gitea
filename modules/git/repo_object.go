...
func (repo *Repository) HashTypeInterface() (HashTypeInterface, error) {
	...
	hash, err := HashTypeInterfaceFromHashString(str)
	if err != nil {
		return nil, err
	}
...
func (repo *Repository) HashObject(reader io.Reader) (HashTypeInterface, error) {

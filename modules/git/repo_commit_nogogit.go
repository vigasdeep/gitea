...
func (repo *Repository) getCommitFromBatchReader(rd *bufio.Reader, id HashTypeInterface) (*Commit, error) {
...
// ConvertToGitHash returns a GitHash object from a potential ID string
